...
Junior Software Developer curious for new tech- and coding possibilities. React/ NextJS and Javascript is the way to go. Highly interested in Python. My goal is to develop into an experienced Full Stack Developer with focus on the MERN tech stack. Knoledge with Cognigy AI low code.
